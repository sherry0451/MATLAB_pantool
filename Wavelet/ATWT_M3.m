...
for i=1:Bands
    ...
    WTP = newndwt2(I_PAN(:,:,i),Levels+1,WF);
    WTXS = newndwt2(I_MS(:,:,i),Levels+1,WF);
    ...
    %%% Injection
    WTP = newndwt2(I_PAN(:,:,i),Levels,WF);
    WTXS = newndwt2(I_MS(:,:,i),Levels,WF);
    ...
    %%% Reconstruction
    I_Fus_ATWT_M3(:,:,i) = newindwt2(WTXS,'c');
